...
@Component
public class RecursoPostAssembler implements RepresentationModelAssembler<Recurso, RecursoPostModel>{

	@Override
	public RecursoPostModel toModel(Recurso entity) {
		RecursoPostModel model = new RecursoPostModel();
	...
	public Recurso toEntity(RecursoPostModel model) {
